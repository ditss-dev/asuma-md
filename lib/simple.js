...
exports.makeWASocket = (connectionOptions, options = {}) => {
    ...
    conn.sendImageAsStickerso = async (jid, path, options = {}, quoted) => {
...
`.trim()
    ...
    conn.sendPoll = (vb, name = '', values = [], selectableCount = 1) => {
        return conn.sendMessage(vb.chat, {
            poll: {
                name,
                values,
                selectableCount
